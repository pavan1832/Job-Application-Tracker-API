        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobLocation = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Companies",
                columns: new[] { "Id", "CreatedAt", "Industry", "Location", "Name", "Notes", "UpdatedAt", "Website" },
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Technology", "San Francisco, CA", "Acme Corp", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "https://acme.com" },
                    { 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Software", "New York, NY", "Tech Solutions Inc.", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "https://techsolutions.com" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FirstName", "LastName", "PasswordHash", "Role", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@jobtracker.com", "Admin", "User", "$2a$11$zMOGMQMpAeHtRuoTq2GZBO7AEMfJjQRuhkGJA3VZnfLEBBBtaUTNu", "Admin", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });
